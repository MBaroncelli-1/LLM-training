...
base_model = "/leonardo_scratch/large/userinternal/$USER/public/models/hub/Mistral-7B-Instruct-v0.3"
lora_path = "./out"
...
with torch.no_grad():
    for example in test_dataset:
        ...
        messages = [
            {"role": "user", "content": f"Summarize the following proposal: {proposal_text}"}
        ]
